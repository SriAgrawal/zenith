...
@interface EDKeyboardAvoidingScrollView () <UITextFieldDelegate, UITextViewDelegate>
@end

@implementation EDKeyboardAvoidingScrollView
...
-(void)setContentSize:(CGSize)contentSize {
    ...
    [self EDKeyboardAvoiding_updateFromContentSizeChange];
}
